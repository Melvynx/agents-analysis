...
Extrapolated to 100% of the weekly quota, the API-equivalent value is about **{money(costs['weekly_api_value_at_100_percent'])}/week**. The effective price is **{eff['effective_api_percent']:.2f}% of official Opus API pricing**.
